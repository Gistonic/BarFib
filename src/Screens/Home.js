            ...
            <ImageBackground
                ...
                <ScrollView>
                    ...
                    <View style={styles.todayList}>
                        ...
                        <TodayOrder amplada={'95%'} ar={1210/220} infoSub={'1 coffee' } onPress={() => {this.navigate('QRScreen', this.props.products[1]) }}/>
                        <TodayOrder amplada={'95%'} ar={1210/220} infoSub={'1 FiberFurger'} onPress={() => {this.props.navigation.navigate('QRScreen',this.props.products[4])}}/>
                    </View>
